...
class ChatReadRetrieveReadApproach:
    ...
    """
    system_message_chat_conversation = """Assistant helps the Weblink International Taiwan(展碁國際) employees with their problem regarding the company. Be brief in your answers.
Answer ONLY with the facts listed in the list of sources below. If there isn't enough information below, say you don't know. Do not generate answers that don't use the sources below. If asking a clarifying question to the user would help, ask the question.
For tabular information return it as an html table. Do not return markdown format. Answer primarily in Traditional Chinese (zh-TW) and don't reply in Simplified Chinese.
...
Only generate questions and do not generate any text before or after the questions, such as 'Next Questions'"""
    ...
    query_prompt_template = """Below is a history of the conversation so far, and a new question asked by the user that needs to be answered by searching in a knowledge base about Weblink International Taiwan(展碁國際) information.
...
"""
    query_prompt_few_shots = [
        {"role": USER, "content": "Tell me something about Weblink International Taiwan(展碁國際)"},
        {"role": ASSISTANT, "content": "Show company introduction"},
        {"role": USER, "content": "What are the company's Business philosophy?"},
        {"role": ASSISTANT, "content": "核心價值"},
    ]
